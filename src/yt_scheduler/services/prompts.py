...
SEED_CLIP_PROPOSALS_HOOK_PROMPT = SeedPrompt(
    ...
    body=(
        ...
        "[MM:SS] timestamp marking when that line is spoken in the "
        "parent video. Use these timestamps as the ONLY anchor for any "
        "range you propose. Do not estimate, do not interpolate — copy "
        "the exact [MM:SS] from the line you want to start at and the "
        "[MM:SS] from the line you want to end at, and convert each to "
        "seconds for the tool input:\n"
        "{{parent_transcript}}\n\n"
